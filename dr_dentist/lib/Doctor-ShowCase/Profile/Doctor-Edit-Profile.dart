...
class _EditDoctorProfileState extends State<EditDoctorProfile> {
  ...
  TextEditingController updateWhatsAppController = TextEditingController();
  TextEditingController updateClinicNameController = TextEditingController();
  ...
  getUser() async {
    ...
    if (doc != null) {
      ...
      updateWhatsAppController = TextEditingController(text: doc["WhatsAppLink"]);
      updateClinicNameController = TextEditingController(text: doc["ClinicName"]);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 25,),
            /// name , mobile , address , whatsapp
            myTextFields(updateNameController, "Name"),
            myTextFields(updateMobileController, "Mobile"),
            myTextFields(updateAddressController, "Address"),
            SizedBox(height: 55,),
  ...
  /// my text field
Padding myTextFields(TextEditingController controller, String title){
    return Padding(
